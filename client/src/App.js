...
import ApplyInsurance from "./pages/user/ApplyInsurances";
import InsuranceApproval from "./pages/InsuranceAdmin/ApproveInsurance";
    ...
    <>
      ...
      {loading ? (
        ...
        <Routes>
          ...
          <Route path='/insurance' element={<ProtectedRoute><ApplyInsurance /></ProtectedRoute>} />;
          <Route path='/approval' element={<ProtectedRoute><InsuranceApproval /></ProtectedRoute>} />;
        </Routes>
      )}
